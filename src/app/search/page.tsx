          ...
          <CardContent className="p-8">
            <div className="space-y-8">
              ...
              <div className="space-y-3">
                ...
                >
                  <SelectTrigger className="h-14 rounded-xl border-2 border-gray-200 text-lg focus:border-blue-600">
              ...
              <div className="pt-6">
                <Button
                  ...
                  className="h-16 w-full rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 text-xl font-semibold text-white shadow-lg transition-all duration-300 hover:from-blue-700 hover:to-purple-700 hover:shadow-xl"
                >
